...
$(document).ready(function () {
  ...
  $('.slider > .photos').slick({
    ...
    prevArrow: $('#prev-photo') // the magic
    // responsive: [{
    // 	breakpoint: 720,
    // 	// settings: "unslick"
    // 	settings: {
  ...
  $('.mobile-menu').click(function (e) {
    ...
    if ($(this).hasClass('open')) {
      $(this).removeClass('open');
      $('.mobile-menu-list').slideUp(); // $(this).parents('.filter-panel').find('.filter').slideDown();
    } else {
      $(this).addClass('open');
      $('.mobile-menu-list').slideDown(); // $(this).parents('.filter-panel').find('.filter').slideUp();
    }
  });
});
...
__webpack_require__(/*! jquery.cookie/jquery.cookie.js */ "./node_modules/jquery.cookie/jquery.cookie.js");

__webpack_require__(/*! jquery-form/src/jquery.form.js */ "./node_modules/jquery-form/src/jquery.form.js");
...
__webpack_require__(/*! /Users/andrew/Projects/girls/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/andrew/Projects/girls/resources/sass/app.scss */"./resources/sass/app.scss");
